...
@Entity
@Table(name = "PREMIUM")
public class Premium implements Serializable, Cloneable {
    ...
    @Column(name = "SumInsured", precision = 15, scale = 2)
    private Double sumInsured;

    @Column(name = "PremiumRate", precision = 5, scale = 2)
    private Double premiumRate;

    @Column(name = "BasicPremiumPeriod", precision = 15, scale = 2)
    private Double basicPremiumPeriod;

    @Column(name = "BasicPremiumTerm", precision = 15, scale = 2)
    private Double basicPremiumTerm;

    @Column(name = "AddOnPremiumPeriod", precision = 15, scale = 2)
    private Double addOnPremiumPeriod;

    @Column(name = "AddOnPremiumTerm", precision = 15, scale = 2)
    ...
    public Double getPremiumRate() { return premiumRate != null ? premiumRate : 0.0; }
    public void setPremiumRate(Double premiumRate) { 
        this.premiumRate = premiumRate; 
        calculateTotalPremiumPeriod(); 
    }

    public Double getBasicPremiumPeriod() { return basicPremiumPeriod != null ? basicPremiumPeriod : 0.0; }
    public void setBasicPremiumPeriod(Double basicPremiumPeriod) { this.basicPremiumPeriod = basicPremiumPeriod; }

    public Double getBasicPremiumTerm() { return basicPremiumTerm != null ? basicPremiumTerm : 0.0; }
    public void setBasicPremiumTerm(Double basicPremiumTerm) { this.basicPremiumTerm = basicPremiumTerm; }

    public Double getAddOnPremiumPeriod() { return addOnPremiumPeriod != null ? addOnPremiumPeriod : 0.0; }
    public void setAddOnPremiumPeriod(Double addOnPremiumPeriod) { this.addOnPremiumPeriod = addOnPremiumPeriod; }

    public Double getAddOnPremiumTerm() { return addOnPremiumTerm != null ? addOnPremiumTerm : 0.0; }
    ...
    // -------------------- Calculation --------------------
    private void calculateTotalPremiumPeriod() {
        if (sumInsured != null && premiumRate != null) {
            this.totalPremiumPeriod = sumInsured * (premiumRate / 100.0); // Assuming premiumRate is in percentage
        } else {
            this.totalPremiumPeriod = 0.0;
        }
    }
